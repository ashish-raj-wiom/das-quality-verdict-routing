// Proves index.html contains exactly the content of
// DAS_Quality_Verdict_Routing_PRD.md — nothing extra, nothing missing.
// Run after every build:  node build-html.js && node check-parity.js
//
// Exits 1 on any drift, so it can gate a commit.
const fs = require('fs');
const dir = __dirname + '/';
const md = fs.readFileSync(dir + 'DAS_Quality_Verdict_Routing_PRD.md', 'utf8');
